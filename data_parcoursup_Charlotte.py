...
parcoursup2023 = drop_parcoursup(parcoursup2023)
parcoursup2023 = rename_parcoursup(parcoursup2023)

parcoursup2023 = parcoursup2023.drop(columns=["statut","code_dep","dep","region","academie","commune",
                                               "filiere","selec","filiere_agr","filiere_det","coord_GPS",
                                               "nb_can_cmp","nb_candidats_classes_prin","nb_candidats_classes_comp",
                                               "nb_candidats_prop","nb_admis_prin","nb_admis_comp",
                                               "nb_admis_bacg","nb_admis_bac","part_bacg","appel",
                                               "type_etablissement","code_form"])
...
parcoursup2022 = drop_parcoursup(parcoursup2022)
parcoursup2022 = rename_parcoursup(parcoursup2022)
parcoursup2022 = parcoursup2022.drop(columns=["statut","code_dep","dep","region","academie","commune",
                                               "filiere","selec","filiere_agr","filiere_det","coord_GPS",
                                               "nb_can_cmp","nb_candidats_classes_prin","nb_candidats_classes_comp",
                                               "nb_candidats_prop","nb_admis_prin","nb_admis_comp",
                                               "nb_admis_bacg","nb_admis_bac","part_bacg","appel",
...
parcoursup2021 = drop_parcoursup(parcoursup2021)
parcoursup2021 = rename_parcoursup(parcoursup2021)
print(2)
...
parcoursup2022 = parcoursup2022.rename(columns={"nb_admis_ac":"nb_admis_ac_2022"})
parcoursup2021 = parcoursup2021.rename(columns={"nb_admis_ac":"nb_admis_ac_2021"})
print(3)

parcoursup2024 = parcoursup2024.merge(parcoursup2023, on = "code_UAI", how='left')
parcoursup2024 = parcoursup2024.merge(parcoursup2022, on = "code_UAI", how='left')
#parcoursup2024 = parcoursup2024.merge(parcoursup2021, on = "code_UAI", how='left')
print(4)
academies = parcoursup2024.groupby(by="academie").sum()

#colonnes = list(academies.columns)
#for col in colonnes:
#   print(col)
